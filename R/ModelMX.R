#' Modelo con un efecto aleatorio y un efecto fijo
#'
#' Realiza una tabla ANOVA para un modelo estadístico que contenga efectos fijos y aleatorios.
...
TablaAnova_MEM<-function(respuesta, fijo, aleatorio, data) {
